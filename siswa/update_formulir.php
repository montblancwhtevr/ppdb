...
<div class="panel-heading">
	<span class="glyphicon glyphicon-edit" style="font-size: 23px;"></span> <b>FORMULIR PENDAFTARAN SISWA BARU</b>
...
if (@$_POST['edit']) {
@$kode_user = mysqli_real_escape_string($con,$_POST['kode_user']);
...
@$jml_saudara = mysqli_real_escape_string($con,$_POST['jml_saudara']);
@$agama = mysqli_real_escape_string($con,$_POST['agama']);
@$alamat = mysqli_real_escape_string($con,$_POST['alamat']);
@$asal_sekolah = mysqli_real_escape_string($con,$_POST['asal_sekolah']);
@$nilai_ijazah = mysqli_real_escape_string($con,$_POST['nilai_ijazah']);
@$nisn = mysqli_real_escape_string($con,$_POST['nisn']);
@$nilai1 = mysqli_real_escape_string($con,$_POST['nilai1']);
@$nilai3 = mysqli_real_escape_string($con,$_POST['nilai3']);
@$nilai4 = mysqli_real_escape_string($con,$_POST['nilai4']);
@$nilai5 = 0;
@$nilai2 = 0;

$query = "UPDATE tb_siswa SET username='$username',pass='$pass',password =md5('$pass'),nama_lengkap='$nama_lengkap',jenis_kelamin='$jenis_kelamin',tempat='$tempat',tgl_lahir='$tgl_lahir',anak_ke='$anak_ke',jml_saudara='$jml_saudara',agama='$agama',alamat='$alamat',asal_sekolah='$asal_sekolah',nilai_ijazah='$nilai_ijazah',nisn='$nisn',nilai1='$nilai1',nilai2='$nilai2',nilai3='$nilai3',nilai4='$nilai4',nilai5='$nilai5' WHERE kode_siswa='$sesi' ";
