...
<body>
  <nav class="brown darken-4 lighten-1" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo"><b style="color: #29b6f6;">PPDB</b> <b style="font-size: 14px; font-family: FZYaoTi;">MUPAT JUNIOR</b></a>
...
<a class="waves-effect brown darken-4 waves-light btn"><i class="material-icons left">collections_bookmark</i>Data Pendaftar</a>-->
  ...
  <footer class="page-footer light-blue">
        ...
        <div class="col l3 s12">
          ...
          <ul>
            <li><a class="white-text" href="#!">
               Dengan adanya Sistem Informasi PPDB Online di SMP MUHAMMADIYAH 4 YOGYAKARTA diharapkan dapat membantu Calon siswa untuk melakukan Pendaftaran Tanpa harus datang ke sekolah untuk melakukan pendaftaran, menghemat biaya dan Waktu.
            </a></li>
          </ul>
        </div>
        <div class="col l3 s12">
          <h5 class="white-text">MUPAT Junior</h5>
          <ul>
            <li><a class="white-text" href="#!">
              Merupakan salah satu Sekolah Muhammadiyah tingkat SMP yang terletak di Gunung Ketur, Pakualaman, Yogyakarta. tentu saja sekolah ini tidak akan kalah dengan sekolah-sekolah lainnya yang mempunyai akreditasi lebih baik.
    ...
    <div class="footer-copyright" style="background-color: #3e2723;">
      <div class="container">
      <b>Dirancang oleh </b>  Tim IT MUPAT JUNIOR <a class="orange-text text-lighten-3" href="">|| Program Pengembangan PPDB</a>
      </div>
    </div>
  </footer>
  ...
  (function(){
      var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
          s1.async=true;
          s1.src='https://embed.tawk.to/5f2e39de5c885a1b7fb74b41/default';
          s1.charset='UTF-8';
