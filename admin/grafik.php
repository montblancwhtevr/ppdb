...
$lulus =mysqli_num_rows(mysqli_query($con,"SELECT * FROM tb_siswa WHERE keterangan='DITERIMA' "));
$tdlulus =mysqli_num_rows(mysqli_query($con,"SELECT * FROM tb_siswa WHERE keterangan='DITERIMA' "));
$cadangan =mysqli_num_rows(mysqli_query($con,"SELECT * FROM tb_siswa WHERE keterangan='TIDAK DITERIMA' "));
    ...
    <div class="col-md-12">
        <div class="panel panel-info">
          <div class="panel-heading">
            ...
            <b>Grafik Calon Siswa Baru SMP MUHAMMADIYAH 4 YOGYAKARTA</b>
