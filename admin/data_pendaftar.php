 ...
 ?>
	<div class="col-md-12">
				<div class="panel panel-primary">
					<div class="panel-heading"><span class="fa fa-database" style="font-size: 23px;"></span> <b> Data Pendaftar</b> 
		...
		<table class="table table-striped table table-bordered table table-hover" id="data">
			...
			<tbody>
				...
				<tr>				
                    ...
                    <td>
					<a href="?page=admin&action=editsiswa&kdsis=<?php echo $data['kode_siswa']; ?>">
					<button type="button" class="btn btn-success">
					<span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
					</button>
					</a>
					<a href="?page=admin&action=hapus&kdsis=<?php echo $data['kode_siswa']; ?>">
