...
if ($pindah)
 {mysqli_query($con,"insert into tb_siswa values ('$kode_siswa','$username','$password','$pass','$nama_lengkap','$jenis_kelamin','$tempat','$tgl_lahir','$anak_ke','$jml_saudara','$agama','$alamat','$asal_sekolah','$nilai_ijazah','$nisn','$nilai1','$nilai2','$nilai3','$nilai4','$nilai5','$keterangan','$siswa','$nama_gambar')") or die (mysqli_error());
