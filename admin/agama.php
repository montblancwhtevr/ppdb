...
<div class="panel-body">
	<table class="tabble table bordered table-striped table table-striped">
		...
		<tbody>
			<?php
				$sql=mysqli_query($con,"SELECT * FROM tb_agama");
				$no=1;
 ...
 // Script update data
    if (isset($_REQUEST['update'])) {
        ...
        $nama_agama = $_REQUEST['nama_agama'];  
         ...
         mysqli_query($con,"UPDATE tb_agama SET 
                                      nama_agama='$nama_agama'
                                      WHERE kode_agama='$kode_agama'") or die(mysqli_error());
          ?>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
			...
			<div class="panel-body">
					                 <?php 
include'inc/koneksi.php';
$carikode = mysqli_query($con,"select max(kode_agama) from tb_agama") or die(mysqli_error());
...
mysqli_query($con,"INSERT INTO tb_agama VALUES ('$kode_agama','$nama_agama')") or die(mysqli_error());
          ?>
<script type="text/javascript">
