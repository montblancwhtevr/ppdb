...
<head>
  ...
  <title> PPDB SMP MUHAMMADIYAH 4 YOGYAKARTA</title>
        ...
        <div class="col s12 m12">
          <div class="card brown darken-4">
            <div class="card-content white-text">
              <span class="card-title"><center> <b style="color: #03a9f4;">PPDB &nbsp;</b >Online <br>
              SMP MUHAMMADIYAH 4 YOGYAKARTA</center></span>
...
<?php
  ...
  $sql = mysqli_query($con,"select * from tb_siswa where username = '$user' and password = md5('$pass') ") or die(mysqli_error());
