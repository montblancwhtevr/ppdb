...
<head>
	...
	<title> Halaman Admin PPDB SMP MUHAMMADIYAH 4 YOGYAKARTA</title>
...
$sql_formulir = mysqli_query($con, "select * from tb_user where kode_user = '$sesi'") or die(mysqli_error());
...
?>
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span style="font-size: 30px;"><b>PPDB</b></span> <b> Online</b> MUPAT JUNIOR</a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li  class="active"><a href="Hal_admin.php"><em class="fa fa-home" style="font-size: 23px;">&nbsp;</em> Home</a></li>
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				<em class="fa fa-table" style="font-size: 23px;">&nbsp;</em> Data Input <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-3">
				...
				<ul class="children collapse" id="sub-item-3">
					<li><a class="" href="?page=admin&action=all_laporan">
						<span class="glyphicon glyphicon-list-alt" style="font-size: 23px;">&nbsp;</span> Laporan PPDB
					</a></li>				
				</ul>
			</li>
...
if ($page=="admin") {
	if ($action=="") {
		...
		include 'admin/agama.php';
	}elseif ($action=="hapus_agama") {
		include 'admin/hapus_agama.php';
	}
